...
#     model_folder = '/data/private/WebNLG-models/simple_model/challenge/pretrained/try_4/*'
    model_folder = '/data/private/WebNLG-models/simple_model/challenge/pretrained_dev/try_5/*'
    model_folders = glob.glob(model_folder)
    
#     save_path = './prediction/challenge/try_4/'
    save_path = './prediction/challenge/try_5_dev/'
